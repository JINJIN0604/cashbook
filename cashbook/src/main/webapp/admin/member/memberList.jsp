			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<table class="table table-bordered">
						...
						%>
							<tr>
								...
								<td><a href="<%=request.getContextPath()%>/admin/member/updateMemberLevelForm.jsp?memberNo=<%=m.getMemberNo()%>&memberId=<%=m.getMemberId()%>&memberName=<%=m.getMemberName()%>" class="btn btn-success">수정</a></td>
								<td><a href="<%=request.getContextPath()%>/admin/member/deleteMemberAction.jsp?memberNo=<%=m.getMemberNo()%>" class="btn btn-danger">삭제</a></td>
							</tr>
						<%
							} 
						%>	
					...
					<div style="text-align : center;" >
						<a href="<%=request.getContextPath()%>/admin/member/memberList.jsp?currentPage=1" class="btn btn-outline-primary" style="text-align: center;">처음</a>
							<%
								if(currentPage > 1) {
							%>
									<a href="<%=request.getContextPath()%>/admin/member/memberList.jsp?currentPage=<%=currentPage-1%>" class="btn btn-primary"><span class="icon-copy ti-angle-left"></span></a>
							<%
								}
							%>
							...
							%>
									<a href="<%=request.getContextPath()%>/admin/member/memberList.jsp?currentPage=<%=currentPage+1%>" class="btn btn-primary"><span class="icon-copy ti-angle-right"></span></a>
							<%		
								}
							%>
						<a href="<%=request.getContextPath()%>/admin/member/memberList.jsp?currentPage=<%=lastPage%>" class="btn btn-outline-primary" >마지막</a>
					</div>
				</div>
			</div>
