			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/admin/notice/noticeList.jsp">공지관리</a></li>
									<li class="breadcrumb-item active" aria-current="page">공지추가</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">공지사항추가</h4>
							<br>
						</div>
					</div>
					<form action="<%=request.getContextPath()%>/admin/notice/insertNoticeAction.jsp">
					<div class="form-group">
						<textarea class="form-control" name="noticeMemo"></textarea>
					</div>
