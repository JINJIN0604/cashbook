				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						...
						<div class="pull-right">
							<a href="<%=request.getContextPath()%>/admin/notice/insertNoticeForm.jsp" class="btn btn-outline-primary btn-sm scroll-click" >공지추가</a>
						</div>
					</div>
					<table class="table table-bordered">
						...
						%>
								<tr>
									...
									<td><a href="<%=request.getContextPath()%>/admin/notice/updateNoticeForm.jsp?noticeNo=<%=n.getNoticeNo()%>" class="btn btn-success">수정</a></td>
									<td><a href="<%=request.getContextPath()%>/admin/notice/deleteNoticeAction.jsp?noticeNo=<%=n.getNoticeNo()%>" class="btn btn-danger">삭제</a></td>
								</tr>
						<%
							}
						%>
