			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">카테고리관리</li>
								</ol>
							</nav>
						</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">카테고리</h4>
							<br>
						</div>
						<div class="pull-right">
							<a href="<%=request.getContextPath()%>/admin/category/insertCategoryForm.jsp" class="btn btn-outline-primary btn-sm scroll-click" >카테고리추가</a>
						</div>
					</div>				
					<table class="table table-bordered">
						...
						%>
							<tr>
								...
								<td><a href="<%=request.getContextPath()%>/admin/category/updateCategoryForm.jsp?categoryNo=<%=c.getCategoryNo()%>" class="btn btn-success">수정</a></td>
								<td><a href="<%=request.getContextPath()%>/admin/category/deleteCategoryAction.jsp?categoryNo=<%=c.getCategoryNo()%>" class="btn btn-danger">삭제</a></td>
							</tr>
						<%
							}
						%>
