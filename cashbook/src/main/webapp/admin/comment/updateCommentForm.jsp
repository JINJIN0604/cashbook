						...
						<table class="table table-bordered">
							<thead>
								...
								<tr>
									<td>문의 생성날짜</td>
									<td>
										<input type="text" name="helpCreatedate" value="<%=help.getCreatedate()%>" style="border:none;" readonly="readonly">
									</td>
								</tr>
								<tr>
									<td>문의 수정날짜</td>
									<td>
										<input type="text" name="helpUpdatedate" value="<%=help.getUpdatedate()%>" style="border:none;" readonly="readonly">
									</td>
								</tr>
								<tr>
									<td>답변 번호</td>
									<td>
										<input type="number" name="commentNo" value="<%=comment.getCommentNo()%>" style="border:none;" readonly="readonly">
									</td>
								</tr>
								<tr>
									<td>답변 ID</td>
									<td>
										<input type="text" name="commentMemberId" value="<%=comment.getMemberId()%>" style="border:none;" readonly="readonly">
									</td>
								</tr>
								<tr>
									<td>답변</td>
								...
								<tr>
									<td>답변 생성날짜</td>
									<td>
										<input type="text" name="createdate" value="<%=comment.getCreatedate()%>" style="border:none;" readonly="readonly">
									</td>
								</tr>
								<tr>
									<td>답변 수정날짜</td>
									<td>
										<input type="text" name="updatedate" value="<%=comment.getUpdatedate()%>" style="border:none;" readonly="readonly">
									</td>
								</tr>
							</thead>
						</table>	
