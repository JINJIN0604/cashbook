			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						...
						<span style="color: blue;"><%=loginMemberName%> 님 </span>						
					</a>
			...
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item" href="<%=request.getContextPath()%>/member/updateMemberForm.jsp">내정보수정</a>
									<a class="dropdown-item" href="<%=request.getContextPath()%>/member/deleteMemberForm.jsp">회원탈퇴</a>
								</div>
							</div>
						</div>											
					</div>
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">마이페이지</h4>
							<br>
						</div>
						<table class="table table-bordered">
							<thead>
								...
								<tr>
									...
									<td>
										******** &nbsp;&nbsp;&nbsp;
										<a href="<%=request.getContextPath()%>/member/updateMemberPwForm.jsp" class="btn btn-success">비밀번호 수정</a>
									</td>
								</tr>
								<tr>
									<td>이름</td>
